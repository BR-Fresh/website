        ...
        <footer className="bg-[#0F3D22] dark:bg-black w-full pt-16 pb-8 border-t border-emerald-800">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-8 max-w-7xl mx-auto">
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        <li><a className="text-emerald-100/70 hover:text-white transition-colors text-sm font-body" href="#">About us</a></li>
                        <li><a className="text-emerald-100/70 hover:text-white transition-colors text-sm font-body" href="#">Careers</a></li>
                        <li><a className="text-emerald-100/70 hover:text-white transition-colors text-sm font-body" href="#">Press</a></li>
                        <li><a className="text-emerald-100/70 hover:text-white transition-colors text-sm font-body" href="#">Blog</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="space-y-4">
                        ...
                        <li><a className="text-emerald-100/70 hover:text-white transition-colors text-sm font-body" href="#">Contact support</a></li>
            ...
            <div className="max-w-7xl mx-auto px-8 mt-16 pt-8 border-t border-emerald-800 flex flex-col md:flex-row justify-between items-center gap-4">
                <p className="text-emerald-100/70 text-sm font-body text-center">
                    © 2024 BR Fresh Private Limited · Privacy Policy · Terms of Service
                </p>
